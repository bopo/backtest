...
def init(dtype='D', export='csv', path=None):
...
def update(dtype='D', export='csv', path=None):
    return Day(path=path, export=export).update()


def bundle(dtype='D', export='csv', path=None):
    return Day(path=path, export=export).bundle()
